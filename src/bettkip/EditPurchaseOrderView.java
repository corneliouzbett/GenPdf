...
import bettkip.api.LabelPropertiesApi;
import bettkip.api.TextFieldsPropertiesApi;
import java.awt.*;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import bettkip.db.MysqlConnection;
import bettkip.db.PurchaseOrderDao;
import bettkip.model.PurchaseOrder;
import java.sql.*;
import java.util.Arrays;
import java.util.List;

public class EditPurchaseOrderView extends JPanel {
    ...
    public EditPurchaseOrderView(PurchaseOrder purchaseOrder) {
        setSize(1050, 800);
        setLayout(null);
        ...
        menubarLabel = new JLabel(" ... UPDATE PURCHASE ORDER DETAILS ...");
        ...
        unitofissue.setText(purchaseOrder.getUnitOfIssue());
        ...
        quantity.setText(String.valueOf(purchaseOrder.getQuantity()));
        ...
        unitcost.setText(String.valueOf(purchaseOrder.getUnitPrice()));
        ...
        pl4 = new JTextField();
        pl4.setText(purchaseOrder.getPl4());
        ...
        requestedby.setText(purchaseOrder.getRequestBy());
        ...
        vehicleno.setText(purchaseOrder.getVehicleNo());
        ...
        lpono.setText(purchaseOrder.getLpoNo());
        ...
        authoriseby.setText(purchaseOrder.getAuthorisedBy());
        ...
        invoiceno.setText(purchaseOrder.getInvoiceNo());
